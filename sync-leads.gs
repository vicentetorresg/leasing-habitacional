...
var HEADERS    = ['Fecha/Hora', 'Nombre', 'Telefono', 'Email', 'Arriendo', 'Sueldo Líquido', 'Fuente', 'DICOM'];
...
function syncLeads() {
  ...
  for (var i = 0; i < rows.length; i++) {
    ...
    sheet.appendRow([ts, r.nombre || '', r.telefono || '', r.email || '', r.arriendo || '', r.renta || '', r.fuente || '', dicomLabel]);
  }
