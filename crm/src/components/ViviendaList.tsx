                    ...
                    {(() => {
                      ...
                      return count > 0 ? (
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1 bg-amber-50 text-amber-600 border border-amber-200 px-2 py-1 rounded-md text-[11px] font-bold hover:bg-amber-100 transition-colors cursor-pointer"
