...
function PDFPage({
  ...
  function onMouseUp() {
    if (!drag || !onFieldAdd || !selectedSignerId) {
      setDrag(null);
      return;
    }
            ...
            <div
              ...
              style={{
                ...
                backgroundColor: isSigned
                  ? "rgba(34, 197, 94, 0.15)"
                  : isActiveSignerField
                  ? `${signer?.color || "#3b82f6"}25`
                  : `${signer?.color || "#3b82f6"}15`,
                border: isSigned
                  ? "2px solid rgb(34, 197, 94)"
                  : isActiveSignerField
                  ? `2px solid ${signer?.color || "#3b82f6"}`
                  : `1.5px dashed ${signer?.color || "#3b82f6"}80`,
                borderRadius: "4px",
            ...
            >
              {isSigned ? (
                ...
                <span
                  ...
                  className="text-xs font-semibold px-1 text-center"
                >
                  {signerMode ? "Clic para firmar" : signer?.name || ""}
                </span>
              ) : (
                <span
                  style={{ color: `${signer?.color || "#3b82f6"}cc` }}
                  className="text-xs font-medium px-1 text-center truncate w-full"
                >
                  {signer?.name || ""}
                </span>
              )}
          ...
          return (
            <div
              style={{
                ...
                width: `${w * 100}%`,
                height: `${h * 100}%`,
                border: `2px dashed ${signer?.color || "#3b82f6"}`,
